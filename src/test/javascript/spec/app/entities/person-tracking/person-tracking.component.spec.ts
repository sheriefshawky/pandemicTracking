...
import { PersonTrackingComponent } from 'app/entities/person-tracking/person-tracking.component';
...
describe('Component Tests', () => {
  describe('PersonTracking Management Component', () => {
    let comp: PersonTrackingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PersonTrackingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.personTrackings && comp.personTrackings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
